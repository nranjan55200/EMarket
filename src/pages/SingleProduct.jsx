                     ...
                     <div className='max-w-6xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10'>
                        ...
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className='flex gap-4 mt-4'>
                                <button onClick={()=>addToCart(SingleProduct)} className='px-6 flex gap-2 py-2 text-lg bg-red-500 text-white rounded-md'><HiOutlineShoppingCart className='w-6 h-6'/> Add to Cart</button>
                            </div>
                        </div>
                     </div>
                </div> :
